    ...
    <div class="py-12 relative z-10">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                <div>
                    <h2 class="text-4xl md:text-5xl font-bold tracking-tight mb-4 text-white">
                ...
                <div class="flex flex-wrap gap-4 flex-shrink-0">
                    <a href="{{ route('analyse') }}" class="group relative px-8 py-4 bg-white/5 border border-white/10 rounded-full font-bold flex items-center gap-3 transition-all hover:bg-white/10 hover:border-indigo-500/50 shadow-xl overflow-hidden text-white">
                    ...
                    <form action="/analyze" method="POST" enctype="multipart/form-data" id="uploadForm">
                        ...
                        <label for="chat_file" class="btn-primary px-8 py-4 rounded-full font-bold flex items-center gap-3 cursor-pointer hover:scale-105 transition transform shadow-xl text-white">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    <div class="glass p-8 rounded-[2.5rem] border border-white/5 shadow-2xl text-white">
